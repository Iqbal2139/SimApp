...
<head>
    ...
    <title>@yield('title') | Sims Web App</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background:darkred;">
            <!-- Brand Logo -->
            <a href="/dashboard" class="brand-link" style="border-bottom:none;">
                <img src="/assets/img/Handbag.png" alt="Sims Web App"
                    class="brand-image">
                <span class="brand-text font-weight-light">Sims Web App</span>
            </a>
